...
export const preferences: Preference[] = [
  {
    ...
    description: '온양온천, 스파 휴양',
    tag: '온천·휴양',
    signals: ['온천 +2', '휴양 +1', '스파 +1', '숙소 체류 +1'],
    weakSignal: '혼잡 도심 - 약함',
    issue: 'No. 01',
    editorialNote: '온양온천처럼 뜨거운 물, 숙소 체류, 느린 회복감을 중심에 둬요.',
    routeHint: '온양온천 · 스파 휴양',
    coverImages: [
  ...
  },
  {
    ...
    description: '불국사, 첨성대, 황리단길',
    tag: '역사·전통',
    signals: ['역사 +2', '전통 +1', '산책 +1', '골목 +1'],
    weakSignal: '리조트 휴양 - 약함',
    issue: 'No. 03',
    editorialNote: '경주처럼 오래된 장소, 골목, 전통의 결을 천천히 따라가요.',
    routeHint: '불국사 · 첨성대',
    coverImages: [
  ...
  },
  {
    ...
    description: '한라산, 올레길, 숲길 산책',
    tag: '자연·트레킹',
    signals: ['자연 +2', '트레킹 +1', '전망 +1', '계절감 +1'],
    weakSignal: '도심 쇼핑 - 약함',
    issue: 'No. 05',
    editorialNote: '한라산처럼 걷는 리듬, 산악 풍경, 폭포와 숲의 장면을 먼저 봅니다.',
    routeHint: '한라산 · 올레길',
    coverImages: [
