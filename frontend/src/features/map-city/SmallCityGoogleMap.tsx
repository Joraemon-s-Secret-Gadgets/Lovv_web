              ...
              markers.map((marker) => {
                ...
                return (
                  <button
                    ...
                    className={`absolute inline-grid h-8 min-w-8 -translate-x-1/2 -translate-y-[38px] place-items-center rounded-full border px-2 text-[11px] font-black leading-none shadow-[0_14px_22px_-14px_rgba(51,39,30,0.55)] transition after:absolute after:left-1/2 after:top-[25px] after:size-3 after:-translate-x-1/2 after:rotate-45 after:border-b after:border-r after:content-[''] hover:-translate-y-[40px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#33271E] ${
                      isSelected
                        ? 'z-20 border-[#A92B10] bg-[#F36B12] text-[#33271E] after:border-[#A92B10] after:bg-[#F36B12]'
                        : 'z-10 border-[#C92E18] bg-[#E73323] text-white after:border-[#C92E18] after:bg-[#E73323] hover:bg-[#F36B12] hover:after:bg-[#F36B12]'
                    }`}
                  >
                    <span className="relative z-10">{marker.label.slice(0, 2)}</span>
                  </button>
                )
              })
            ) : (
