...
/**
 * Detects whether a PlanStop is a free-meal placeholder card generated by the
 * backend (e.g. "선택 도시에서 식사 장소를 자유롭게 선택하세요").
 * These stops should be filtered out from the numbered timeline list and map
 * markers so that the itinerary only shows substantive attraction stops.
 */
export const isMealPlaceholderStop = (stop: PlanStop): boolean => {
