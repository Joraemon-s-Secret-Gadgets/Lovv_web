...
- Scope: current generated plan result, liked state, saved plan write helper, duplicate prevention.
- Dependencies: Task 4.2.
- Context Budget: Must read plan draft helper and generated detail UI sections.
- Acceptance Criteria: Like toggles; save persists; repeated save does not duplicate; actions are accessible.
